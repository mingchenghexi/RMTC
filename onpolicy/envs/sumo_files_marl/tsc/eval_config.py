...
config = {
    ...
    "environment": {
        ...
        # "state_key": ['current_phase', 'car_num', 'queue_length', "occupancy", 'flow', 'stop_car_num', 'pressure', 'neighbor_index', 'neighbor_dis'],
...
map_configs = {
    ...
    # },
    'base': {
        'net': 'sumo_files_marl/scenarios/sumo_fenglin_base_road/fenglin_y2z_t.net.xml',
        'route': 'sumo_files_marl/scenarios/sumo_fenglin_base_road/fenglin_y2z_t.rou.xml',#读取非随机车流的文件
        'end_time': 3600,
    },
    # 'rl_wj': {
    ...
    # },
    'grid4x4': {
        'net': 'sumo_files_marl/scenarios/resco_envs/grid4x4/grid4x4.net.xml',
        'route': 'sumo_files_marl/scenarios/resco_envs/grid4x4/grid4x4_1.rou.xml',
        'end_time': 3600,
    },
    'arterial4x4': {
        'net': 'sumo_files_marl/scenarios/resco_envs/arterial4x4/arterial4x4.net.xml',
        'route': 'sumo_files_marl/scenarios/resco_envs/arterial4x4/arterial4x4_1.rou.xml',
        'end_time': 3600,
    },
    'ingolstadt21': {
        'net': 'sumo_files_marl/scenarios/resco_envs/ingolstadt21/ingolstadt21.net.xml',
        'route': 'sumo_files_marl/scenarios/resco_envs/ingolstadt21/ingolstadt21.rou.xml',
        'end_time': 57600 + 3600,
    },
    'cologne8': {
        'net': 'sumo_files_marl/scenarios/resco_envs/cologne8/cologne8.net.xml',
        'route': 'sumo_files_marl/scenarios/resco_envs/cologne8/cologne8.rou.xml',
        'end_time': 25200 + 3600,
    },
}
#需要评估的指标
